module.exports = {
  ...
  camera: 'https://res.cloudinary.com/devbook/image/upload/c_scale,w_35/v1467410971/devbook/app-images/Flat-Camera-Icon.png',
  photo_wall: 'http://res.cloudinary.com/devbook/image/upload/h_261,w_261,o_30,c_fill/v1467916740/devbook/app-images/photo-wall-default.jpg',
  logo_pic_black: 'http://res.cloudinary.com/devbook/image/upload/v1468019293/devbook/app-images/DB-logo-pic-black.png',
  logo_pic_blue: 'http://res.cloudinary.com/devbook/image/upload/v1468019293/devbook/app-images/DB-logo-pic-blue.png',
  logo_pic_white_black: 'http://res.cloudinary.com/devbook/image/upload/v1468019292/devbook/app-images/DB-logo-white-black.png',
  logo_pic_white_blue: 'http://res.cloudinary.com/devbook/image/upload/v1468019292/devbook/app-images/DB-logo-white-blue.png',
